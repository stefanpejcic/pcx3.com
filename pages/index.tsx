        ...
        <div className="grid grid-cols-1 space-y-10 py-4 sm:space-y-5 sm:py-14 xl:grid-cols-5">
          <div className="col-span-3 justify-center space-y-5 align-middle">
            ...
            <p className="text-black dark:text-white sm:pr-6 sm:text-lg sm:leading-8">
              Have a good read! <span className="waving-hand text-2xl">👋🏻</span>  Hi, my name is Stefan Pejčić. I am forging my decade plus experience within IT doing: Technical Support, Web Hosting, System Administration, and WordPress development.
